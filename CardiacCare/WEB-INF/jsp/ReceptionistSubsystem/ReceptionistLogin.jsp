	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-50">
				<html:form action="/ReceptionistLoginPath" styleClass="login100-form validate-form">
					<span class="login100-form-title p-b-33">
						Receptionist Account Login
					</span>

					<div class="wrap-input100 validate-input">
						&nbsp;<h3>Email</h3>
						<html:text styleId="Email" styleClass="input100" property="frmRepLoginEmail"></html:text>
						 
						<span class="focus-input100-1"></span>
						<span class="focus-input100-2"></span>
						<html:errors property="frmRepLoginEmail"/>
					</div>

					<div class="wrap-input100 rs1 validate-input">
						&nbsp;<h3>Password</h3>
						<html:password styleId="Password" styleClass="input100" property="frmRepLoginPassword"></html:password>
						
						<span class="focus-input100-1"></span>
						<span class="focus-input100-2"></span>
						<html:errors property="frmRepLoginPassword"/>
