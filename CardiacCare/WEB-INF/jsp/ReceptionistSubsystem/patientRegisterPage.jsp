...
<html lang="en">
<head>
<title>PatientRegisterPage</title>
<%@ include file="../inc/calendar.jsp"%>
<!-- <link href="./resource/css/receptionist-css/library.css" rel="stylesheet" type="text/css"> -->
<meta charset="utf-8">
<meta name="viewport"
...
<logic:empty property="frmRegFormControl" name="PatientRegisterFormBean">
						...
						<table class="table table-hover table-striped bg-info">
							...
							<tbody>
								...
								<tr class="table-info">
									<td>Date Of Birth:</td>
									<td><html:text property="regPatientDOB"
											styleId="calendar" styleClass="form-control" /> <html:image
											src="./resource/images/calendar.gif" styleId="trigger"
											style="cursor: pointer; border: 1px solid red;"
											title="Date selector"
											onmouseover="this.style.background='red';"
											onmouseout="this.style.background=''"></html:image> <font
										face="Verdana" size="2" color="green">&nbsp;YYYY-MM-DD</font>
										...
										<br/>
										<html:errors property="regPatientDOB" />
								...
								<tr class="table-info">
								 ...
								 <tr class="table-info">
									...
									<td><html:textarea styleClass="form-control" 
										property="regPatinetAddress" ></html:textarea>
								...
								<tr class="table-info">
									<td>Lab Result:</td>
									<td><html:file
										styleClass="form-control-file btn-info" property="regUploadFile" ></html:file>
						...
						<table class="table table-hover table-striped">
							...
							<tbody>
								...
								<tr class="table-info">
									<td>Phone Number:</td>
									<td><html:textarea styleClass="form-control" 
										property="regPatientPhnoe" disabled="true"></html:textarea> </td>
								</tr>
