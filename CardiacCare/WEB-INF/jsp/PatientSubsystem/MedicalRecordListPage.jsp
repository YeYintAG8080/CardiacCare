...
<body onload="showDate()">
	...
	<div class="wrapper d-flex align-items-stretch">
		...
		<div id="content" class="p-4 p-md-5">
			...
			<div class="container">
			<logic:empty property="frmDailyRecordList" name="PatientFormBean">
				...
				<div class="row">
					...
					<logic:notEmpty property="frmDailyRecordList" name="PatientFormBean">
						<logic:iterate id="dailyRecord" name="PatientFormBean"
							property="frmDailyRecordList">
							<a
								href="DailyMedicalRecord.do?frmLinkControl=2&frmDailyRecordId=<bean:write name="dailyRecord" property="id"/>">
