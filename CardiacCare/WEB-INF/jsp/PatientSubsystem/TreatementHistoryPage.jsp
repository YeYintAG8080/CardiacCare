...
<link rel="stylesheet" href="./resource/css/doctor-css/patient-style.css">
</head>
		...
		<div id="content" class="p-4 p-md-5">
			...
			<div class="container">
				...
				<div class="row">
					<table class="table table-hover table-striped">
						...
						<tbody>
							<tr class="table-info">
								...
								<bean:write name="PatientFormBean" property="frmTreatment.treatmentDate" format="MM-dd-YYYY"/>
							...
							<tr class="table-info">
								<td>Doctor Name:</td>
								<td>${PatientFormBean.frmTreatment.doctor.doctorName}</td>
							</tr>
							<tr class="table-info">
								<td>Suggestion:</td>
								<td class="text-justify">${PatientFormBean.frmTreatment.suggestion}</td>
							</tr>

						</tbody>
					</table>

					<logic:empty name="PatientFormBean" property="frmInjectionDoseList">
									 
					</logic:empty>
					<logic:notEmpty name="PatientFormBean" property="frmInjectionDoseList">
					<table class="table">
						...
						<tbody>
							<logic:present name="PatientFormBean">
								<logic:iterate name="PatientFormBean" id="injection_item"
									...
									<tr class="table-info">
										...
										<td>
										<logic:match value="0" name="injection_item" property="complete">
											Not complete
										</logic:match>
										<logic:match value="1" name="injection_item" property="complete">
											Completed
										</logic:match>
										</td>
									</tr>
					...
					<logic:empty name="PatientFormBean" property="frmMedicineList">
									 
					</logic:empty>
					<logic:notEmpty name="PatientFormBean" property="frmMedicineList">
					<table class="table">
						...
						<tbody>
							<logic:present name="PatientFormBean">
								...
								<logic:iterate name="PatientFormBean" id="medicine_item"
