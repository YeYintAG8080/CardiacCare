...
<body>
	...
	<section id="team" class="pb-5">
		...
		<div class="row">
			<div class="col-md-2">
			<html:img alt="${DoctorTeamFormBean.frmDoctorDetail.doctorImage}" src="./image/doctor_profile_images/${DoctorTeamFormBean.frmDoctorDetail.doctorImage}" style="width:150px;height:250px;"/>
			</div>
			<div class="col-md-3">
			Name: <bean:write name="DoctorTeamFormBean" property="frmDoctorDetail.doctorName"/>	<br/>
			Degree: <bean:write name="DoctorTeamFormBean" property="frmDoctorDetail.degree"/> <br/>
			Specialization: <bean:write name="DoctorTeamFormBean" property="frmDoctorDetail.specialization"/><br/>
			</div>
			<div class="col-md-7">
				<p style="text-align: justify;">
				<bean:write name="DoctorTeamFormBean" property="frmDoctorDetail.biography"/>
				</p>
			</div>
		</div>
		</div>
